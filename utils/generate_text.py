...
def generate_structured_text(prompt, response_format, max_tokens=10000, temperature=0.7, model_in = "gpt-4o-mini"):
    """
    Generic function to generate text using OpenAI's ChatGPT API.
    Response is structured from the given JSON
    ...
    try:
        ...
        print(f"Error in generate_structured_text: {e}")
        return None